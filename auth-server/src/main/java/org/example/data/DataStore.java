...
public class DataStore {
    ...
    static volatile Map<String, TokenInfo> tokenInfoMap;
    ...
    public static void init() {
        ...
        tokenInfoMap = new ConcurrentHashMap<>();
     ...
     * @param userId user id
     */
    public static void setTokenAndUser(@NotNull String token, @NotNull Long userId) {
        TokenInfo tokenInfo = new TokenInfo();
        tokenInfo.setCreateAt(new Date());
    ...
    public static User getUserByToken(@NotNull String token) {
        final TokenInfo tokenInfo = tokenInfoMap.get(token);
        if (tokenInfo == null) {
            return null;
        }
        Date nowDate = new Date();
        final Date tokenDate = tokenInfoMap.get(token).getCreateAt();
        ...
        return getUserById(tokenInfoMap.get(token).getUserId());
    }
